    ...
    return (
        <main>
            <div className="flex flex-col items-center p-8 bg-orange-950 text-yellow-50">
                <h1 className="text-4xl font-bold text-red-200">¡Hola, mundo!</h1>
                <p className="text-lg mt-4">¡Bienvenido a mi sitio web!</p>
            </div>
        </main>
    )
...
export function SunButtonExample() {
    return (
        <button aria-label="Cambiar a modo oscuro" className="bg-yellow-800 text-yellow-50 rounded-full p-2 w-min">
...
export function SunButtonDarkExample() {
    return (
        <button aria-label="Cambiar a modo oscuro" className="bg-yellow-100 text-slate-900 rounded-full p-2 w-min">
            <SunIcon className="w-6 h-6" />
        </button>
    );
}
        ...
        <main>
            <div className="flex flex-col items-center p-4 bg-yellow-100 dark:bg-orange-950 text-slate-900 dark:text-yellow-50">
                <div className="flex justify-end w-full">
                    <button
                        aria-label="Cambiar a modo oscuro" className="bg-yellow-800 text-yellow-50 dark:bg-yellow-100 dark:text-slate-900 rounded-full p-2 w-min">
                        <SunIcon className="w-6 h-6" />
                    </button>
                </div>
