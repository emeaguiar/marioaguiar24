        ...
        <div
            className={ clsx(
                ...
                'lg:-mx-8 lg:max-w-screen-md',
                {
                    ...
                    'border-yellow-400 bg-yellow-50 text-yellow-800 dark:border-yellow-700 dark:bg-yellow-950 dark:text-yellow-100': type === 'important',
                    'border-red-400 bg-red-50 text-red-800 dark:border-red-400 dark:bg-red-950 dark:text-red-100': type === 'warning',
                    'border-purple-400 bg-purple-50 text-purple-800 dark:border-purple-400 dark:bg-purple-950 dark:text-purple-100': type === 'caution',
                }
            ) }
        >
            {
