...
updatedOn: '2024-07-21T03:13:45.417Z'
...
a new error object.
    - `mah_email_error` is the code we use for this specific error, when we work with multiple errors it's a good idea to give them a code.
    - Then we can give specify the message that will be use when we display this error to the user.
