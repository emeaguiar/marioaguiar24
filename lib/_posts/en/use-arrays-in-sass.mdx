...
updatedOn: '2024-07-21T22:44:57.016Z'
description: >-
...
Even though it is a somewhat old tool, for more than 10 years SASS has been one
...
One of the most used examples of these tools is the ability to use arrays in sass
(or vectors, as my teachers used to say in school). This allows us to _create loops,
maps_, etc. This way we can share information between our files and even save several
lines of code.

In SASS, arrays are known as **lists**, in their most basic version, a list is declared
as follows:

<Code language='scss' children={`$colors: yellow, blue, red, green;`} />

This way, we can access any element in the array with the `nth` function:

<Code
  language='scss'
  children={`$colors: yellow, blue, red, green;
@debug nth($colors, 2);
