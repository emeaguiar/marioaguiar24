...
updatedOn: '2024-07-23T01:54:23.999Z'
description: >-
...
In the [first part of this tutorial](/create-a-settings-page-in-wordpress-with-react),
...
to __add text fields, and save the options__.
...
![Options page with text field](/posts/create-a-settings-page-in-wordpress-with-react-part-2/settings-field.webp)
...
![Toggle as checkbox](/posts/create-a-settings-page-in-wordpress-with-react-part-2/plain-toggle.webp)
...
![Options page with text field and toggle](/posts/create-a-settings-page-in-wordpress-with-react-part-2/fancy-toggle.webp)
...
![Options page with text field, toggle, and save button](/posts/create-a-settings-page-in-wordpress-with-react-part-2/full-settings.webp)
