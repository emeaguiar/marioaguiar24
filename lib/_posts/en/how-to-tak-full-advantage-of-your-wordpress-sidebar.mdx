...
publishedOn: "2010-10-23"
description: Sidebars on blogs are underestimated, and usually you see the exact same sidebar on every single page of a blog, I think that is just a waste of space. But when used properly, you can turn your lame sidebar into a killer sidebar!
---
...
messing around in your theme** you can just use the __index.php__ file, to do that just 
find the line where the sidebar is called:

<Code
    language="php"
    children={`<?php get_sidebar(); ?>`}
/>
...
That code will show our __single-sidebar__ ONLY if we are on a single post. If not, 
it will show our __default sidebar__.
...
This goes into your __functions.php__ file (noticed the importance of this file already?)
