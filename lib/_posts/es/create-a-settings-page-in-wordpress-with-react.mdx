...
<Code language='bash' children={`npm install --save-dev @wordpress/scripts`} />
...
<Code language='js' children={`console.log( 'Hello settings' );`} />
...
![Vista del editor con los archivos creados](/posts/create-an-options-page-in-wordpress-with-react/editor-config.webp)
...
![Página de opciones en WordPress con React imprimiendo "Hello Settings" en la consola](/posts/create-an-options-page-in-wordpress-with-react/settings-page.webp)
