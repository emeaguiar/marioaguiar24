...
date: "2024-07-17"
description: En éste rápido tutorial agregaros un botón para activar modo oscuro a nuestros componentes con Tailwind.
---
...
# Crear un botón para cambiar el modo oscuro en React con Tailwind
...
oscuro dentro de nuestra aplicación Next.js con Tailwind CSS**.
...
cambiar el color de nuestro componente si el usuario cambia las preferencias de, esto afortunadamente
es fácil de solucionar, simplemente agregamos el media query dentro del mismo archivo 
de configuración de Tailwind. Así:
