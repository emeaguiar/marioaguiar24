...
![Mensaje de éxito en WordPress](/posts/create-a-settings-page-in-wordpress-with-react-part-3/success.webp)
...
[^1]: Los `stores` son el lugar en dónde la lógica de la applicación vive, en 
un formato de Redux; es dónde se guarda el `state` y los `reducers` de la aplicación.
[^2]: Dentro del editor utilizariamos `createNotice` que mostraría nuestro mensaje junto a los 
