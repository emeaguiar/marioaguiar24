...
updatedOn: '2024-07-21T03:13:45.421Z'
...
`$email` será un nuevo objeto de error.
    - `mah_email_error` es el código que usamos para este error específico, cuando
trabajamos con varios errores es una buena idea darles un código.
    - Luego podemos especificar el mensaje que se usará cuando mostremos este error al usuario.
