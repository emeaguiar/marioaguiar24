...
updatedOn: '2024-08-16T16:48:08.860Z'
description: >-
...
al número entero más cercano (por ejemplo 52.2 se convertirá en 53)[^2]
    * Viene de _ceiling_, techo en inglés
...
<Code
    language="ts"
    children={`const text = document.querySelector(".article").innerText; // Es importante usar \`innerText\`;
